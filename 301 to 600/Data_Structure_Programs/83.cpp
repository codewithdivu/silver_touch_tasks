...
int main() {
    ...
    std::cout << "Is 0 connected to 2? " << (g.is_connected(0, 2) ? "Yes" : "No") << std::endl;
    std::cout << "Is 1 connected to 3? " << (g.is_connected(1, 3) ? "Yes" : "No") << std::endl;

    g.disconnect(0, 1);
    std::cout << "Is 0 connected to 2 after disconnecting 0 from 1? " << (g.is_connected(0, 2) ? "Yes" : "No") << std::endl;
    std::cout << "Is 1 connected to 3 after disconnecting 0 from 1? " << (g.is_connected(1, 3) ? "Yes" : "No") << std::endl;
